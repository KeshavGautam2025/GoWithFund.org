    ...
    <div className='text-[var(--color-dark)] bg-gray-100 border-t border-gray-200 mt-3'>
        <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col items-center space-y-3">
            <div className='flex flex-col md:flex-row items-center justify-between w-full max-w-2xl space-y-2 md:space-y-0 md:space-x-4'>
                ...
                <Link href="https://github.com/GoWithFund-Org" className="text-sm text-[var(--color-dark)] hover:text-black">
                    GitHub
                </Link>
            ...
            <div className='flex flex-row items-center justify-between max-w-2xl gap-5 mt-4'>
                ...
                <Link href="https://linkedin.com/company/gowithfund" className="text-sm text-[var(--color-dark)] hover:text-black">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                      <path
